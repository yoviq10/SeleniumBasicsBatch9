...
public class HandlingPagination {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        firstNameField.sendKeys("Hinata");
        WebElement lastNameField = driver.findElement(By.id("lastName"));
        lastNameField.sendKeys("Shoyo");


        WebElement empIdField=driver.findElement(By.id("employeeId"));
        String empId= empIdField.getAttribute("value");  //get attribute will always return a string value
        ...
        boolean flag=true;
        while(flag){
            List<WebElement> tableRows= driver.findElements(By.xpath("//table[@id = 'resultTable']/tbody/tr"));//initialized row of tables inside while loop
            for(int i=0; i<tableRows.size();i++){
                ...
                if(rowText.contains(empId)){
                    ...
                    deleteButton.click();
                    WebElement confirmDelete= driver.findElement(By.id("dialogDeletebtn")); //Webbased alert
                    confirmDelete.click();
                    break;
